...
BATCH_SIZES=(1 2)
REPETITIONS=5         # Default value 1

# Experiment group name
EXPERIMENT_GROUP="fast_jul3"

# List of optimizers
OPTIMIZERS= ("SGD" "KFAC" "Adam" "Adagrad" "RMSprop" "LBFGS")

#("KFAC" "LBFGS" "Adam" "Adagrad" "RMSprop" "SGD_with_momentum" "SGD")
